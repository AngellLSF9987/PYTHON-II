...
class RepositorioEspecifico:
    ...
    def cargar_especificos(self, lista_especificos):
        """
        Carga la lista de géneros específicos en la biblioteca.
        """
        for especifico in lista_especificos:
            nuevo_especifico = Especifico(especifico["nombre"], especifico["genero"])
            self.especificos.append(nuevo_especifico)
            self.diccionario_especificos[nuevo_especifico.nombre] = nuevo_especifico
